...
(function (scenes) {
    var Opt3a = (function (_super) {
        ...
        Opt3a.prototype.start = function () {
            ...
            this._opt2aButton = new objects.Button("opt3a_btn1", config.Screen.CENTER_X - 200, config.Screen.CENTER_Y + 100);
            this.addChild(this._opt2aButton);
            // LEFT_CAVE Button event listener
            this._opt2aButton.on("click", this._opt2aButtonClick, this);
            // add the LEFT_CAVE button to the MENU scene
            this._opt2bButton = new objects.Button("opt3a_btn2", config.Screen.CENTER_X + 180, config.Screen.CENTER_Y + 100);
